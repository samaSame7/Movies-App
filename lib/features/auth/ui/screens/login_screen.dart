            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Icon(Icons.play_circle_outline, size: 120, color: AppColors.primary),
                  const SizedBox(height: 60),
                  ...
                  Align(
                      ...
                      child: TextButton(
                          onPressed: () {},
                          child: const Text('Forget Password ?', style: TextStyle(color: AppColors.primary))
                      )
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      const Text("Don't Have Account ? ", style: TextStyle(color: AppColors.textLight)),
                      GestureDetector(
